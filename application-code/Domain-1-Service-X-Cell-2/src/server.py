...
@app.route('/')
def home():
    print("inside method home  of Domain-2-Service-X-Cell-2.internal-Domain2.com This is cell 1")
    ...
    return "<html><head><title>Domain-2-Service-X-Cell-2</title></head><body bgcolor=#FF1493><p><h1 style=color:#00BFFF>You have hit Domain-2-Service-X-Cell-2 from node %s</h1> </p></body></html>" % ( socket.gethostname() )
